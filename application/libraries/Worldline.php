...
/**
 * CodeIgniter Worldline Payment Gateway
 *
 * @package CodeIgniter
 * @author  Lee & Nee Software(Exports) Ltd.
 * @link    http://lnsel.com/
 */

require_once APPPATH . 'third_party/phpToolKit/Kit/AWLMEAPI.php';

class Worldline extends AWLMEAPI 
{
