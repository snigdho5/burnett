...
<div class="container-fluid">
 ...
 <div class="container-fluid home_top_images pt-5">
    <div class="container">
        <div class="row">
        <div class="col-md-12 text-center text-md-left"><h4>Latest Products</h4></div>
        </div>
        <div class="row text-center text-md-left">
            <div class="col-md-3 pb-3"><a href="#"><img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/latest-product-01.jpg" alt="" /></a></div>
            <div class="col-md-3 pb-3"><a href="#"><img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/latest-product-02.jpg" alt="" /></a></div>
            <div class="col-md-3 pb-3"><a href="#"><img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/latest-product-03.jpg" alt="" /></a></div>
            <div class="col-md-3 pb-3"><a href="#"><img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/latest-product-04.jpg" alt="" /></a></div>        
        </div>
        <div class="row pt-4 text-center text-md-left">
        <div class="col-md-3">
        <div class="row bardhe">
        <div class="feature-col col-md-12 kolonat-hom">
            <div class="ikonat-home"> <span><img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/Free-Delivery01.png" alt="" /></span> </div>
            <div class="teksti-home"><h4 class="title">Free Delivery</h4>
        ...
        <div class="feature-col col-md-12 kolonat-hom">
            <div class="ikonat-home"> <span><img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/30-Days-Return01.png" alt="" /></span> </div>
            <div class="teksti-home"><h4 class="title">30 Days Return</h4>
        ...
        <div class="row bardhe top_icons_line">
        <div class="feature-col col-md-12 kolonat-hom">
            <div class="ikonat-home"> <span><img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/Secure-Payment01.png" alt="" /></span> </div>
            <div class="teksti-home"><h4 class="title">Secure Payment</h4>
        ...
        <div class="row bardhe top_icons_line">
        <div class="feature-col col-md-12 kolonat-hom">
            <div class="ikonat-home"> <span><img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/24-7-Support01.png" alt="" /></span> </div>
            <div class="teksti-home"><h4 class="title">24/7 Support</h4>
 ...
 <div class="container-fluid">
    <div class="container">
        ...
        <div class="container">    
            ...
            <div class="product-grid4">
                <div class="product-image4">
                    <a href="#"><img class="pic-1" src="<?php echo base_url();?>assets/frontend/images/Ashoka-Tonic01.jpg" alt=""/> </a>
                   <!-- <ul class="social">
                ...
                <div class="product-content">
                    <h3 class="title"><a href="#">Ashoka Tonic</a></h3>
                    <div class="price">
                        <i class="fa fa-inr" aria-hidden="true"></i> 80.00 – <i class="fa fa-inr" aria-hidden="true"></i>  185.00
                        <!-- <span>$16.00</span>-->
                    </div>
        ...
        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 pl-1 pr-1">
            <div class="product-grid4">
                <div class="product-image4">
                    <a href="#"><img class="pic-1" src="<?php echo base_url();?>assets/frontend/images/Aptone-Forte01.jpg" alt=""/> </a>
                    <!-- <ul class="social">
                        <li><a href="#" data-tip="Quick View"><i class="fa fa-eye"></i></a></li>
                        <li><a href="#" data-tip="Add to Wishlist"><i class="fa fa-shopping-bag"></i></a></li>
                        <li><a href="#" data-tip="Add to Cart"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="product-content">
                    <h3 class="title"><a href="#">Aptone Forte</a></h3>
                    <div class="price">
                        <i class="fa fa-inr" aria-hidden="true"></i>90.00
                        <!-- <span>$16.00</span>-->
                    </div>
                    <a class="add-to-cart" href="">ADD TO CART</a>
                </div>
        ...
        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 pl-1 pr-1">
            <div class="product-grid4">
                <div class="product-image4">
                    <a href="#"><img class="pic-1" src="<?php echo base_url();?>assets/frontend/images/baby-vit-01.jpg" alt=""/> </a>
                     <!-- <ul class="social">
                        <li><a href="#" data-tip="Quick View"><i class="fa fa-eye"></i></a></li>
                        <li><a href="#" data-tip="Add to Wishlist"><i class="fa fa-shopping-bag"></i></a></li>
                        <li><a href="#" data-tip="Add to Cart"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="product-content">
                    <h3 class="title"><a href="#">Babivit</a></h3>
                    <div class="price">
                        <i class="fa fa-inr" aria-hidden="true"></i>60.00
                        <!-- <span>$16.00</span>-->
                    </div>
                    <a class="add-to-cart" href="">ADD TO CART</a>
                </div>
        ...
        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 pl-1 pr-1">
            <div class="product-grid4">
                <div class="product-image4">
                   <a href="#"><img class="pic-1" src="<?php echo base_url();?>assets/frontend/images/acidex01.jpg" alt=""/> </a>
                     <!-- <ul class="social">
                        <li><a href="#" data-tip="Quick View"><i class="fa fa-eye"></i></a></li>
                        <li><a href="#" data-tip="Add to Wishlist"><i class="fa fa-shopping-bag"></i></a></li>
                        <li><a href="#" data-tip="Add to Cart"><i class="fa fa-shopping-cart"></i></a></li>
                ...
                <div class="product-content">
                    <h3 class="title"><a href="#">Acidex</a></h3>
                    <div class="price">
                     <i class="fa fa-inr" aria-hidden="true"></i>85.00 - <i class="fa fa-inr" aria-hidden="true"></i>195.00
                        <!-- <span>$16.00</span> -->
                    </div>
                    <a class="add-to-cart" href="">ADD TO CART</a>
                </div>
...
<div class="container-fluid home_img">
        <div class="row">
        <img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/bady_img_edit1.jpg"  alt=""/>
        </div>
</div>
...
<div class="container-fluid home_suffering pt-5 pb-5">
    <div class="container">
        <div class="row">                
            ...
            <div class="col-md-6">
            <img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/blue_bg_img01.png"  alt=""/>
            </div>
       </div>
   </div>
</div>
<div class="container-fluid home_img pt-5 pb-5">
    <div class="container">
        ...
        <img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/one-img01.jpg"  alt=""/>
        </div>
...
<div class="container-fluid">
    <div class="container">
        <div class="row">
            ...
            <img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/100-plus.jpg"  alt=""/>
            <h5>29</h5>
            <p>Years of experiance in homeopathy</p>
            </div>
            <div class="p-2 green_boxss">
            <img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/gmp-icon.jpg"  alt=""/>
            <h5>GMP</h5>
            <p>Certified</p>
            </div>
            <div class="p-2 green_boxss">
            <img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/iso-icon.jpg"  alt=""/>
            <h5>ISO</h5>
            <p>9001: 2015 Cetified</p>
            </div>
            <div class="p-2 green_boxss">
            <img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/Secure-icon.jpg"  alt=""/>
            <h5>Secure</h5>
            <p>Reliable &amp; Trusted</p>
            </div>
            <div class="p-2 green_boxss">
            <img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/Millions-icon.jpg"  alt=""/>
            <h5>Millions</h5>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card-content">
                    <div class="card-img">
                        <img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/blog01.jpg" alt=""/>                        
                    </div>
                    <div class="card-desc">
            ...
            <div class="col-md-4">
                <div class="card-content">
                    <div class="card-img">
                        <img class="img-fluid" src="<?php echo base_url();?>assets/frontend/images/blog03.jpg" alt=""/>                        
                    </div>
                    <div class="card-desc">
                        <h4>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h4>
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Laboriosam, voluptatum! Dolor quo, perspiciatis
