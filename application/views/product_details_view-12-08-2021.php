        ...
        <div class="row">
            <div class="col-md-5">
                <div id="slider" class="owl-carousel product-slider">
                    ...
                    <?php foreach ($product_details_image as $key => $row_image) { //echo "<pre>";print_r($row_image);?>


                        <?php if ($key == '0') { ?>
                            <div class="item imagebig1">
                                <img data-toggle="magnify" src="<?php echo base_url(); ?>uploads/product/small/<?php echo $row_image->product_image; ?>" />
                            </div>
                        <?php } else { ?>
                            <div class="item imagebig1">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 pl-1 pr-1 mb-4">
                        ...
                        <div class="product-grid4">
                            <div class="product-image4">
								...
								<a href="<?php echo base_url();?>product-details/<?php echo $row->unique_key; ?>"><img class="pic-1" src="<?php echo base_url(); ?>uploads/product/small/<?php echo $row->product_image; ?>" alt="" /></a>
