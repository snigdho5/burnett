                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 pl-1 pr-1">
                                <div class="product-grid4">
                                    <div class="product-image4">
                                        ...
                                        <?php if ($row->product_image != '') { ?> <a href="<?php echo base_url(); ?>product-details/<?php echo $row->unique_key; ?>"><img class="pic-1" src="<?php echo base_url(); ?>uploads/product/small/<?php echo $row->product_image; ?>" alt="" /> </a> <?php } ?>
