                      ...
                      <?php if(@$row->coupon_discount !=""){?>
                        ...
                        <?php } ?>
                            ...
                            <td colspan="2" class="text-right"> <strong><i class="fa fa-inr" aria-hidden="true"></i> <?php echo number_format($row->order_total_value,2);?></strong></td>
                             ...
                             <?php if($row->pay_wallet_amount >0  ){ ?>

                             <tr>
                            <td></td>
                            <td colspan="2"></td>
                            <td></td>
                            <td class="text-right"><strong>Wallet Pay</strong>: </td>                          
                            <td colspan="2" class="text-right"> <strong><i class="fa fa-inr" aria-hidden="true"></i> <?php echo number_format($row->pay_wallet_amount,2);?></strong></td>
                             </tr>
                            ...
                            <td colspan="2" class="text-right"> <strong><i class="fa fa-inr" aria-hidden="true"></i> <?php echo number_format(@$row->order_total_value-@$row->pay_wallet_amount,2);?></strong></td>
                             </tr>
