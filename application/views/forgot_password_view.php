      ...
      <a class="nav-link" data-toggle="tab" href="#stockist-registration">Stockist Registration</a>
        ...
        <div class="tab-content">
          ...
          <div id="user-registration" class="container tab-pane active"><br>
            <form class="form-horizontal" id="cu_registration_form" action="<?php echo base_url(); ?>Forgot_password/forgot_pass_submit_data" method="post" enctype="multipart/form-data">
              ...
              <div class="form-group ">
                <button type="submit" onclick="return forgot_form_validation()" class="btn btn-primary btn-lg login-button">Submit</button>
              </div>
            </form>
          </div>
