				...
				<div class="col"> 
						...
						<div id="carouselExampleIndicators" class="carousel slide">
								...
								<div class="carousel-inner"> 
                                        ...
                                        <img src="<?php echo base_url();?>assets/frontend/images/banner-new1.jpg" alt=""/>
												<div class="carousel-caption d-md-block">
                                                <div class="col-md-6 col-12">
														<h3 data-animation="animated bounceInLeft">BEST QUALITY HOMEO MEDICINE</h3>
														<h4 data-animation="animated bounceInRight">A Leading homoeopathic medicine manufacturing laboratory in india</h4>
                                                        <h5 data-animation="animated bounceInLeft">Burnett gives you a new life...</h5>															
												</div></div>
										</div>
										
										<!-- second slide -->
										<div class="carousel-item"> <img src="<?php echo base_url();?>assets/frontend/images/banner-new1.jpg" alt=""/>
												<div class="carousel-caption d-md-block">
                                                <div class="col-md-6 col-12">
														<h3 data-animation="animated bounceInLeft">BEST QUALITY HOMEO MEDICINE</h3>
														<h4 data-animation="animated bounceInRight">A Leading homoeopathic medicine manufacturing laboratory in india</h4>
...
<div class="container-fluid home_img">
    <div class="row">
		...
		<?php
			$YTvideoID = $youtube[0]->youtube_video_id;
			echo '<iframe width="1500" height="315" src="https://www.youtube.com/embed/'.$YTvideoID.'?autoplay=1&mute=1&controls=0"></iframe>';
		?>
    </div>
</div>
