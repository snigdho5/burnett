          ...
          <form name="checkout_form_id" id="checkout_form_id" action="<?php echo base_url();?>checkout/checkout_submit_data" method="post"  class="needs-validation" novalidate="">
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3">
                <label for="firstName">Default Address</label>
                <input type="radio" class="form-control" onclick="change_default_bill_address();" id="default_bill_address" name="default_bill_address" placeholder="Enter your Name" checked value="set_default" >
               
              </div>

            <?php } ?>
              <div class="col-md-6 mb-3">
                <label for="lastName">New Address</label>
                <input type="radio" class="form-control" id="new_bill_address" name="default_bill_address" onclick="change_default_bill_address();" placeholder="Enter your Email" value="new_billing" <?php if(count(@$user_billing_address_details)==0){ echo 'checked';} ?> >
...
<script type="text/javascript">
 ...
 var base_url='<?php echo base_url(); ?>';
       ...
       $.ajax({
             ...
             data:{default_bill_address:default_bill_address},
              dataType: "html",
                type: "POST",
...
<script type="text/javascript">
 ...
 var base_url='<?php echo base_url(); ?>';
       ...
       $.ajax({
             ...
             data:{state:state,coupon_code:coupon_code},
              dataType: "json",
                type: "POST",
