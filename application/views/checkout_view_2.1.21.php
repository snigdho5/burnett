          ...
          <form name="checkout_form_id" id="checkout_form_id" action="<?php echo base_url();?>checkout/checkout_submit_data" method="post"  class="needs-validation" enctype="multipart/form-data" novalidate="">
            ...
            <?php } ?>
              <div class="custom-control custom-radio col-md-6 mb-3">
                ...
                <input class="form-control custom-control-input" type="radio" id="new_bill_address" name="default_bill_address" onclick="change_default_bill_address();" placeholder="Enter your Email" value="new_billing" <?php if(count(@$user_billing_address_details)==0){ echo 'checked';} ?> >
