					...
					?>
                        ...
                        <?php if ($key == '0') { ?>
                            <div class="item imagebig1">
                                <img data-toggle="magnify" src="<?php echo base_url(); ?>uploads/product/small/<?php echo $row_image->product_image; ?>" alt="<?php echo isset($product_info[0]->product_title)?$product_info[0]->product_title:'';?>"/>
                            </div>
                        <?php } else { ?>
                            <div class="item imagebig1">
                                <img src="<?php echo base_url(); ?>uploads/product/small/<?php echo $row_image->product_image; ?>" alt="<?php echo isset($product_info[0]->product_title)?$product_info[0]->product_title:'';?>" />
                            </div>
                        <?php } ?>
                                    ...
                                    <ul>
                                        ...
                                        ?>
                                            <li>
                                                <ul>
                                                    <li class="checkbox-detail">
                                                        <input type="checkbox" value="<?php echo $pv->variable_attribute_id; ?>" id="check_<?php echo $pv->variable_attribute_id; ?>" name="chkpack[]"><input type="hidden" name="txtsize_<?php echo $pv->variable_attribute_id; ?>" value="<?php echo $product_att_val[0]->name; ?>" />
                                                    </li>
                                ...
                                <div class="tabs">
                                    <div class="tab">
                                        ...
                                        <div class="tab-content"> <?php echo $product_details[0]->indication_english_text; ?><br>
                                            ...
                                            ?>
                                                <img id="myImg" src="<?php echo base_url() . 'uploads/product/' . $product_details[0]->indication_english_img; ?>" alt="Snow" style="width:100%;max-width:300px; margin:20px auto; display:block;">
                                            <?php
                                            }
                                            ?>
                                    ...
                                    <div class="tab">
                                        ...
                                        <div class="tab-content"> <?php echo $product_details[0]->indication_hindi_text; ?> </br>
                                            ...
                                            ?>
                                                <img id="myImg-hin" src="<?php echo base_url() . 'uploads/product/' . $product_details[0]->indication_hindi_img; ?>" alt="Snow" style="width:100%;max-width:300px; margin:20px auto; display:block;">
                                            <?php
                                            }
                                            ?>
                                            <!-- The Modal -->
                                    ...
                                    <div class="tab">
                                        ...
                                        <div class="tab-content"> <?php echo $product_details[0]->indication_bengali_text; ?></br>
                                            ...
                                            ?>
                                                <img id="myImg-ben" src="<?php echo base_url() . 'uploads/product/' . $product_details[0]->indication_bengali_img; ?>" alt="Snow" style="width:100%;max-width:300px; margin:20px auto; display:block;">
                                            <?php
                                            }
                                            ?>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 pl-1 pr-1 mb-4">
                        ...
                        <div class="product-grid4">
                            <div class="product-image4">
								...
								<a href="<?php echo base_url();?>product-details/<?php echo $row->unique_key; ?>"><img class="pic-1" src="<?php echo base_url(); ?>uploads/product/small/<?php echo $row->product_image; ?>" alt="<?php echo isset($row->product_title)?$row->product_title:'';?>" /></a>
