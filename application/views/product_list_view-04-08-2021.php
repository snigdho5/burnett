      ...
      <div class="col-md-3 pl-0 pr-0 home_side_bar mt-5 mb-5">
        ...
        <div class="col-md-12 home_cat_list">
          <ul>
            ...
            <li><a href="<?php echo base_url().'product-list/'.$row->unique_name; ?>"><i class="fa fa-angle-right" aria-hidden="true"></i> <?php echo $row->name;?></a>
              <?php 
...
if(count(@$sub_category_list)>0){  ?>
              <ul>
                ...
                <li><a href="<?php echo base_url().'product-list/'.@$my_parent_category_details[0]->unique_name.'/'.$subcatrow->unique_name; ?>"> <i class="fa fa-angle-right" aria-hidden="true"></i> <?php echo $subcatrow->name;?></a></li>
                <?php } ?>
              </ul>
              <?php } ?>
            </li>
             ...
             <ul id="show_filter_product">
				 ...
				 <li class="no-heading">
                            <ul>
                                ...
                                <li class="potency"><div class="screen-resize" style="display: none;">Potency</div><select name="ddlsizebox" id="ddlsize_<?php echo $row->product_id;?>" onchange="">  
                                <?php
                    if($row->product_type=='simple'){ 
