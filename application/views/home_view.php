...
<div class="container-fluid pt-5">
    <div class="row">
        <div class="col-md-6 home_blue_bg">
			...
			<?php echo isset($content[0]->left_content)?$content[0]->left_content:'';?>
            <!--<ul>
                <?php
        ...
        <div class="col-md-6 home_green_bg">
			...
			<?php echo isset($content[0]->right_content)?$content[0]->right_content:'';?>
            <!--<ol>
				<?php
...
<div class="container-fluid home_img" style="display: none;">
    <div class="row">
...
<div class="container-fluid home_suffering pt-5 pb-5" style="display: none;">
    <div class="container">
        <div class="row">
...
<div class="container-fluid home_img pt-5 pb-5" style="display: none;">
    <div class="container">
        <div class="row">
...
<!-- Blog -->
<div class="container home_blog pt-5 pb-5" style="display: none;">
