...
<div class="row blog_list pt-2">
            ...
            <div class="col-md-4 mb-3">
                <div class="card-content">
                    <div class="card-img">
                       <?php if($row->image !=''){ ?> <img class="img-fluid" src="<?php echo base_url();?>uploads/news/<?php echo $row->image;?>" alt=""/>     <?php } ?>                   
                    </div>
                    <div class="card-desc">
                        <h4><?php echo $row->news_title;?></h4>
                        <p><?php echo character_limiter(@$row->description,60);?></p>
                            <a href="<?php echo base_url();?>news-details/<?php echo $row->news_id;?>/<?php echo $row->news_slug;?>" class="btn-card">Read More</a>   
                    </div>
                </div>
            </div>
