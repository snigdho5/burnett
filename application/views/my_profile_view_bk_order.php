...
foreach($order_list as $row){
  ...
  <tr align="center">
    ...
    <td><button type="button" class="btn btn-success" data-toggle="modal" data-target="#myModaltt<?php echo $count_order; ?>">
View
</button></td>
  ...
  <tr align="center">
    ...
    <td><i class="fa fa-inr" aria-hidden="true"></i>  <?php
                    ...
                    $price= $product_details[0]->product_price;
                       ...
                       echo $price;
                    ?></td>
    <td><a title="delete"  href="my_profile/delete_wishlist/<?php echo $row->wish_id;?>" id="del"  onclick="return confirm('Are you sure ?')" class="btn btn-danger delete_button"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>
  </tr>
