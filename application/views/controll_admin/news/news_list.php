      ...
      <?php /*?><div class="span12">
        ...
        <div class="span12 stone_details" id="stone_details">
          <div class="widget ">
            <div class="widget-header "> <i class="icon-list-ol"></i>
              <h3>News List</h3>
              <div class="pull-right"><a href="news/add_view" class="btn btn-success">ADD NEWS</a> </div>
            </div>
            <!-- /widget-header -->
                ...
                <table class="table-condensed table-striped dataTables_filter" id="table_of_list">
                  <thead>
                    <tr>
                      ...
                      <th class="span1">News Title.</th>
                      <th class="span2">News Category</th>
                      <th class="span5">News Description</th>
                      <th class="span5">News Image</th>
        ...
        //  print_r($products);
                    ...
                    <tr>
                      ...
                      <td><img src="<?php echo $row->image==''?base_url().'assets/images/default_img.jpg':base_url().'uploads/news/'.$row->image;?>" title="" alt="User Image" style="height:50px; width:50px;"/></td>
                      ...
                      <td><?php if($row->status=='1')
						{
						?>
                            <a href="news/change_status/<?php echo $row->news_id.'/0';?>" class="btn btn-success">Active</a>
                        <?php
						}
						else
						{
						?>
							<a href="news/change_status/<?php echo $row->news_id.'/1';?>" class="btn btn-danger">Disable</a>
                        <?php
						}
						?></td>
                      <td class="span4"><!--<a href="#" class="btn btn-success"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>&nbsp; &nbsp;--><a title="delete"  href="news/delete/<?php echo $row->news_id;?>" id="del"  onclick="return confirm('Are you sure ?')" class="btn btn-danger delete_button"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>&nbsp;&nbsp;<a title="Edit" href="news/edit_view/<?php echo $row->news_id;?>" class="btn btn-success"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
