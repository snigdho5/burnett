...
<div class="main">
   ...
   <?php } ?>
     <form class="" name="add_area"  method="post" action="<?php echo base_url().BaseAdminURl.'/';?>news/data_edit_submit" id="pro_submit_form" enctype="multipart/form-data">
            ...
            <div class="widget-content panel-collapse collapse in" id="general_details_area">
                  ...
                  <div class="span4">
                      ...
                      <div class="controls">
                       ...
                       <input type="text" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="news_title" value="<?php echo @$edited_details[0]->news_title;?>" name="news_title" placeholder="News Title">
                      ...
                      <div class="controls">
                       ...
                       <input type="file" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="news_image"  name="news_image" placeholder="Coupon Code">
                        ...
                        <input type="hidden" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="old_pic" value="<?php echo @$edited_details[0]->image;?>" name="old_pic" placeholder="Total Use">  
                          ...
                          <input type="hidden" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="edited_news_id" value="<?php echo @$edited_details[0]->news_id;?>" name="edited_news_id" placeholder="Total Use">            
