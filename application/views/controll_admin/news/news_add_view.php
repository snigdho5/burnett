...
<div class="main">
   ...
   <?php } ?>
     <form class="" name="add_area"  method="post" action="<?php echo base_url().BaseAdminURl.'/';?>news/data_add_submit" id="pro_submit_form" enctype="multipart/form-data">
          ...
          <div class="widget ">
            ...
            <div class="widget-content panel-collapse collapse in" id="general_details_area">
                  ...
                  <div class="span4">
                      ...
                      <label class="control-label" for="stonegroup_name"> News Title</label>
                      <div class="controls">

                       <input type="text" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="news_title" value="" name="news_title" placeholder="News Title">
                  ...
                  <div class="span4">
                   ...
                   <div class="span4">
                      ...
                      <div class="control-group">
                      <label class="control-label" for="stonegroup_name">News Image</label>
                      <div class="controls">

                       <input type="file" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="news_image"  name="news_image" placeholder="Coupon Code">
                  ...
                  <div class="span4">
                      ...
                      <div class="control-group">
                      <label class="control-label" for="stonegroup_name">News Description</label>
                      <div class="controls">

                      
                                          
                          <textarea class="form-control" rows="3" name="description" id="description" placeholder="Description" data-validation="required" data-validation-error-msg="Please enter description"></textarea>           
...
function cu_data_Submit_fm()
{
        ...
        if (news_title=="") 
        {
            $('#news_title').removeClass('black_border').addClass('red_border');
        } 
        else 
        {
            $('#news_title').removeClass('red_border').addClass('black_border');  
        ...
        if (news_image=="") 
        {
            $('#news_image').removeClass('black_border').addClass('red_border');
        } 
        else 
        {
            $('#news_image').removeClass('red_border').addClass('black_border');               
        }
