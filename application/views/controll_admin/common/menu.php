  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
		...
		<!------ Manage Home Page Starts ------>
		<li class="<?=$mainpage=="message"?'active':''?>  dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user"></i><span>Manage Home Page</span> <b class="caret"></b></a>
			<ul class="dropdown-menu">
				<li>
					<a href="<?php echo base_url();?>controll_admin/message"> <i class="icon-user"></i><span> Message</span></a>
				</li>
				<li>
					<a href="<?php echo base_url();?>controll_admin/message/saveYTvideo"> <i class="icon-user"></i><span> YouTube Video</span></a>
				</li>
				<li>
					<a href="<?php echo base_url();?>controll_admin/message/staticContent"> <i class="icon-user"></i><span> Static Content</span></a>
				</li>
				<li>
					<a href="<?php echo base_url();?>controll_admin/message/get_your_choice_list"> <i class="icon-user"></i><span> get Your Choice</span></a>
				</li>
				
				<li>
					<a href="<?php echo base_url();?>controll_admin/message/featured_prodcut_list"> <i class="icon-user"></i><span> Featured Product </span></a>
				</li>
				
				<li>
					<a href="<?php echo base_url();?>controll_admin/message/commitment"> <i class="icon-user"></i><span> Manage Commitment </span></a>
				</li>
				
				<li>
					<a href="<?php echo base_url();?>controll_admin/message/image_seven"> <i class="icon-user"></i><span> Upload Single Image </span></a>
				</li>
				
				<li>
					<a href="<?php echo base_url();?>controll_admin/message/image_eight"> <i class="icon-user"></i><span> Upload Suffering Image </span></a>
				</li>
				
			</ul>
		</li>
		<!------ Manage Home Page Ends ------>
