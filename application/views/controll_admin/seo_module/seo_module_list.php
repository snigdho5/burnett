        ...
        <div class="span12 stone_details" id="stone_details">
          <div class="widget ">
            <div class="widget-header "> <i class="icon-list-ol"></i>
              <h3>SEO List</h3>
              <div class="pull-right"><a href="seo_module/add_view" class="btn btn-success">ADD SEO</a> </div>
            </div>
            <!-- /widget-header -->
                ...
                <table class="table-condensed table-striped dataTables_filter" id="table_of_list">
                  <thead>
                    <tr>
                      ...
                      <th class="span2">Seo Meta Title</th>
                      <th class="span5">Seo Meta Keyword</th>
                      <th class="span5">Seo Meta Description</th>
                  ...
                  <tbody id="stone_area">
					...
					$search = array();
        //  print_r($products);
					if(!empty($seo_module_list))
					{ 
					foreach($seo_module_list as $row)
					{
						$count++;
						?>
                    <tr>
                      ...
                      <td><?php  echo character_limiter($row->meta_keyword,60); ?></td>
                      <td><?php  echo character_limiter($row->meta_description,60); ?></td>
                    ...
                    <!--   <td><?php if($row->status=='1')
						{
						?>
                            <a href="seo_module/change_status/<?php echo $row->seo_module_id.'/0';?>" class="btn btn-success">Active</a>
                        <?php
						}
						else
						{
						?>
							<a href="seo_module/change_status/<?php echo $row->seo_module_id.'/1';?>" class="btn btn-danger">Disable</a>
                        <?php
						}
						?></td> -->
                      <td class="span4">

                       <!--  <a title="delete"  href="seo_module/delete/<?php echo $row->seo_module_id;?>" id="del"  onclick="return confirm('Are you sure ?')" class="btn btn-danger delete_button"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a> -->&nbsp;&nbsp;<a title="Edit" href="seo_module/edit_view/<?php echo $row->seo_module_id;?>" class="btn btn-success"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
