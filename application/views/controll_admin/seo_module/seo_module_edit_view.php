...
<div class="main">
   ...
   <?php } ?>
     <form class="" name="add_area"  method="post" action="<?php echo base_url().BaseAdminURl.'/';?>seo_module/data_edit_submit" id="pro_submit_form" enctype="multipart/form-data">
            ...
            <div class="widget-content panel-collapse collapse in" id="general_details_area">
                  ...
                  <div class="span4">
                      ...
                      <div class="controls">
                       ...
                       <input type="text" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="title" value="<?php echo @$edited_details[0]->title;?>" name="title" placeholder="Blog Title">

                       <input type="hidden" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="seo_module_id" value="<?php echo @$edited_details[0]->seo_module_id;?>" name="seo_module_id" placeholder="Total Use">
