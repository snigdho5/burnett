      ...
      <?php /*?><div class="span12">
        ...
        <div class="span12 stone_details" id="stone_details">
          <div class="widget ">
            <div class="widget-header "> <i class="icon-list-ol"></i>
              <h3>Blog List</h3>
              <div class="pull-right"><a href="blog/add_view" class="btn btn-success">ADD BLOG</a> </div>
            </div>
            <!-- /widget-header -->
                ...
                <table class="table-condensed table-striped dataTables_filter" id="table_of_list">
                  <thead>
                    <tr>
                      ...
                      <th class="span1">Blog Title.</th>
                      <th class="span2">Blog Category</th>
                      <th class="span5">Blog Description</th>
                      <th class="span5">Blog Image</th>
        ...
        //  print_r($products);
                    ...
                    <tr>
                      ...
                      $category_details = $this->common_my_model->common($table_name ='category', $field = array(), $where = array('cat_id'=>$row->category_id), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');

                         echo $category_details[0]->name;

                      ?></td>
                      
                      <td><?php echo character_limiter(@$row->description,60);?> </td>
                     
                      
                      
                      
                      <td><img src="<?php echo $row->image==''?base_url().'assets/images/default_img.jpg':base_url().'uploads/blog/'.$row->image;?>" title="" alt="User Image" style="height:50px; width:50px;"/></td>
                      ...
                      <td><?php if($row->status=='1')
						{
						?>
                            <a href="blog/change_status/<?php echo $row->blog_id.'/0';?>" class="btn btn-success">Active</a>
                        <?php
						}
						else
						{
						?>
							<a href="blog/change_status/<?php echo $row->blog_id.'/1';?>" class="btn btn-danger">Disable</a>
                        <?php
						}
						?></td>
                      <td class="span4"><!--<a href="#" class="btn btn-success"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>&nbsp; &nbsp;--><a title="delete"  href="blog/delete/<?php echo $row->blog_id;?>" id="del"  onclick="return confirm('Are you sure ?')" class="btn btn-danger delete_button"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>&nbsp;&nbsp;<a title="Edit" href="blog/edit_view/<?php echo $row->blog_id;?>" class="btn btn-success"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
