...
<div class="main">
   ...
   <?php } ?>
     <form class="" name="add_area"  method="post" action="<?php echo base_url().BaseAdminURl.'/';?>blog/data_add_submit" id="pro_submit_form" enctype="multipart/form-data">
            ...
            <div class="widget-content panel-collapse collapse in" id="general_details_area">
                  ...
                  <div class="span4">
                      ...
                      <div class="controls">
                       ...
                       <input type="text" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="blog_title" value="" name="blog_title" placeholder="Blog Title">
...
function cu_data_Submit_fm()
{
        ...
        if (blog_image=="") 
        {
            $('#blog_image').removeClass('black_border').addClass('red_border');
        } 
        else 
        {
            $('#blog_image').removeClass('red_border').addClass('black_border');               
        }
