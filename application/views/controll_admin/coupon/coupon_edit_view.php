...
<div class="main">
   ...
   <?php } ?>
     <form class="" name="add_area"  method="post" action="<?php echo base_url().BaseAdminURl.'/';?>coupon/data_edit_submit" id="pro_submit_form" enctype="multipart/form-data">
            ...
            <div class="widget-content panel-collapse collapse in" id="general_details_area">
                  ...
                  <div class="span4">
                      ...
                      <div class="controls">
                       ...
                       <input type="text" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="coupon_headline" value="<?php echo @$edited_details[0]->coupon_headline;?>" name="coupon_headline" placeholder="Coupon Title">
                   ...
                   <div class="span4">
                      ...
                      <div class="controls">
                       ...
                       <input type="text" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="coupon_code" value="<?php echo @$edited_details[0]->coupon_code;?>" name="coupon_code" placeholder="Coupon Code">
                                          
                          <input type="hidden" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="edited_coupon_id" value="<?php echo @$edited_details[0]->coupon_id;?>" name="edited_coupon_id" placeholder="Total Use">            
                  ...
                  <div class="span4">
                      ...
                      <div class="controls">
                                                    ...
                                                    <option value="Flat" <?php if(@$edited_details[0]->coupon_discount_type=='Flat'){echo 'selected';} ?>  >Flat</option>
                                                    <option value="Persent" <?php if(@$edited_details[0]->coupon_discount_type=='Persent'){echo 'selected';} ?> >Persent</option>
                  ...
                  <div class="span4">
                      ...
                      <div class="controls">
                       ...
                       <input type="text" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="coupon_discount" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="<?php echo @$edited_details[0]->coupon_discount;?>" name="coupon_discount" placeholder="Coupon Discount">
                   ...
                   <div  class="span4">
                     ...
                     <div class="control-group">
                      ...
                      <div class="controls">
                       ...
                       <input type="text" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="coupon_amount" onkeypress='return event.charCode >= 48 && event.charCode <= 57' value="<?php echo @$edited_details[0]->coupon_amount;?>" name="coupon_amount" placeholder="Coupon Amount">
                   ...
                   <div  class="span4">
                     ...
                     <div class="control-group">
                      ...
                      <div class="controls">
                       ...
                       <input type="date" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="coupon_end" value="<?php echo @$edited_details[0]->coupon_end;?>" name="coupon_end" placeholder="Expire Date">
                   ...
                   <div  class="span4">
                     ...
                     <div class="control-group">
                      ...
                      <div class="controls">
                       ...
                       <input type="text" data-validation="required" onkeypress='return event.charCode >= 48 && event.charCode <= 57' data-validation-error-msg="Please enter title" class="form-control" id="total_use" value="<?php echo @$edited_details[0]->total_use;?>" name="total_use" placeholder="Total Use">
