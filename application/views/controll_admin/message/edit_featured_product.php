                            ...
                            <div class="widget-content panel-collapse collapse in" id="general_details_area">
								...
								<div class="span4">
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="product_url" value="<?php echo isset($editMsg[0]->url)?$editMsg[0]->url:'';?>" class="form-control" placeholder="Enter featured product url" data-validation="required" >
											<?php echo form_error('product_url', '<div class="text-danger">', '</div>'); ?>
										</div> 
									</div>
								</div>
								...
								<div class="span4">
									<div class="control-group">
										<label class="control-label" for="stonegroup_name"> Image<i class="text-danger" style="color : red">*</i><small><?php echo '&nbsp;&nbsp;&nbsp;';?>(jpeg|jpg|png are allowed only)<br>[width: 275 px, height: 90 px]</small></label>
										<div class="controls">
