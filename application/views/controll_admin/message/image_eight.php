                            ...
                            <div class="widget-content panel-collapse collapse in" id="general_details_area">
								...
								<div class="span4">
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="title" value="<?php echo isset($editMsg[0]->title)?$editMsg[0]->title:'';?>" class="form-control" placeholder="Enter image title" data-validation="required" >
								...
								<div class="span4">
									<div class="control-group">
										<label class="control-label" for="stonegroup_name"> Text </label>
										<div class="controls">
											<textarea name="text_msg" class="form-control" rows="3" placeholder="Enter text message" data-validation="required"><?php echo isset($editMsg[0]->text_msg)?$editMsg[0]->text_msg:'';?></textarea>
										</div> 
									</div>
								</div>
								...
								<div class="span4">
									<div class="control-group">
										<label class="control-label" for="stonegroup_name"> Upload Image <i class="text-danger" style="color : red">*</i> <small><?php echo '&nbsp;&nbsp;&nbsp;';?>(jpeg|jpg|png are allowed only) <br>[width: 540 px, height: 470 px]</small> </label>
										<div class="controls">
