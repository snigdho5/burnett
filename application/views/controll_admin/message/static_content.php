                            ...
                            <div class="widget-content panel-collapse collapse in" id="general_details_area">
                                ...
                                <div class="span4">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="left_content" id="left_content_id" class="form-control note-text-cls" rows="3" placeholder="Message" data-validation="required" data-validation-error-msg="Please enter left content"><?php echo isset($editMsg[0]->left_content)?$editMsg[0]->left_content:'';?></textarea>
                                ...
                                <div class="span4">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="right_content" id="right_content_id" class="form-control note-text-cls" rows="3" placeholder="Message" data-validation="required" data-validation-error-msg="Please enter left content"><?php echo isset($editMsg[0]->right_content)?$editMsg[0]->right_content:'';?></textarea>
