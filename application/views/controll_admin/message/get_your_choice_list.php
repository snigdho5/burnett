                ...
                <div class="span12 stone_details" id="stone_details">
                    <div class="widget ">
                        <div class="widget-header ">
                            ...
                            <h3>Choice List</h3>
                            <div class="pull-right"><a href="<?php echo base_url();?>controll_admin/message/get_your_choice" class="btn btn-success">Add New</a> </div>
                        </div>
                        <!-- /widget-header -->
                                    ...
                                    <tbody id="stone_area">
                                        ...
                                        <tr>
											...
											<?php if($value->status == 1){ ?>
												<a href="<?php echo base_url().BaseAdminURl.'/';?>message/change_status/<?php echo isset($value->id)?$value->id:'';?>" class="btn btn-success">Active</a>
											<?php }else{ ?>
												<a href="<?php echo base_url().BaseAdminURl.'/';?>message/change_status/<?php echo isset($value->id)?$value->id:'';?>" class="btn btn-danger">Inactive</a>
											<?php } ?>
											</td>
                                            <td>
                                                <a href="<?php echo base_url().BaseAdminURl.'/';?>message/edit_get_your_choice/<?php echo isset($value->id)?$value->id:'';?>" title="Edit" class="btn btn-success"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
												
												<a href="<?php echo base_url().BaseAdminURl.'/';?>message/do_delete/<?php echo isset($value->id)?$value->id:'';?>" onclick="return confirm('Are you sure you want to delete it ?')" title="delete"  class="btn btn-danger delete_button"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
