                            ...
                            <div class="widget-content panel-collapse collapse in" id="general_details_area">
								...
								<div class="span4">
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="product_url" value="<?php echo set_value('product_url');?>" class="form-control" placeholder="Enter featured product url" data-validation="required" >
