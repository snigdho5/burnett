                            ...
                            <div class="widget-content panel-collapse collapse in" id="general_details_area">
								...
								<div class="span4">
									<div class="control-group">
										<label class="control-label" for="stonegroup_name"> YouTube Video ID </label>
										<div class="controls">
											<input type="text" name="youtube_video_id" id="youtube_video_id" value="<?php echo isset($editMsg[0]->youtube_video_id)?$editMsg[0]->youtube_video_id:'';?>" class="form-control" placeholder="Enter youtube video id" data-validation="required" >
											<?php echo form_error('youtube_video_id', '<div class="text-danger">', '</div>'); ?>
										</div> 
									</div>
								</div>
...
<script type="text/javascript">
    ...
    {
		var youtube_video_id = $("#youtube_video_id").val();
		if (youtube_video_id ==""){
			$('#youtube_video_id').removeClass('black_border').addClass('red_border');
		}else{
			$('#youtube_video_id').removeClass('red_border').addClass('black_border');
		}
    }
