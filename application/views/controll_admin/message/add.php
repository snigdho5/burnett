                            ...
                            <div class="widget-content panel-collapse collapse in" id="general_details_area">
                                <div class="span4">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <textarea class="form-control" rows="3" name="message" id="message_id" placeholder="Message" data-validation="required" data-validation-error-msg="Please enter message"><?php echo set_value('product_dec');?></textarea>
