              ...
              <div class="widget-content panel-collapse collapse in" id="general_details_area">
                ...
                <div class="span4">
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="alt_for_product_image" value="" class="form-control" placeholder="Alt For Product Image">
                    </div>
                    <label class="sell-price-msg"></label>
                  </div>
                </div>
              ...
              <div class="widget-content panel-collapse collapse in" id="price_details_area">
                ...
                <div class="span4">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <textarea class="form-control" rows="3" name="info_for_doctor" id="info_for_doctor" placeholder="Information for Doctor" data-validation="required" data-validation-error-msg="Please enter Information for Doctor"></textarea>
                ...
                <div class="span4">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <textarea class="form-control" rows="3" name="product_description" id="product_description" placeholder="Description" data-validation="required" data-validation-error-msg="Please enter Description"></textarea>
                ...
                <div class="span4">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <textarea class="form-control" rows="3" name="product_component" id="product_component" placeholder="Component" data-validation="required" data-validation-error-msg="Please enter Component"></textarea>
                ...
                <div class="span4">
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="alt_for_english_indication_image" value="" class="form-control" placeholder="Alt For English Indication Image">
                    </div>
                    <label class="sell-price-msg"></label>
                  </div>
                </div>
                ...
                <div class="span4">
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="alt_for_hindi_indication_image" value="" class="form-control" placeholder="Alt For Hindi Indication Image">
                    </div>
                    <label class="sell-price-msg"></label>
                  </div>
                </div>
                ...
                <div class="span4">
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" name="alt_for_bengali_indication_image" value="" class="form-control" placeholder="Alt For Bengali Indication Image">
                    </div>
                    <label class="sell-price-msg"></label>
                  </div>
                </div>
