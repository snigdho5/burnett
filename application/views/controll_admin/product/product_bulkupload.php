    ...
    <div class="main-inner">
        ...
        <div class="container">
            ...
            <div class="row">
				...
				<form class="" name="add_area" method="post" action="<?php echo base_url().BaseAdminURl.'/';?>product/product_bulk_upload" id="pro_submit_form" enctype="multipart/form-data">
                        ...
                        <div class="widget ">
                            ...
                            <div class="widget-content panel-collapse collapse in" id="stone_details_area">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <button type="submit" name="submitBtn" onclick="return pro_form_validation();" class="btn btn-default btn-submit">Submit</button>
