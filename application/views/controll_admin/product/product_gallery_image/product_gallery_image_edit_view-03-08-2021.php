          ...
          <div class="widget ">
            ...
            <div class="widget-content panel-collapse collapse in" id="general_details_area">
                  ...
                  <div class="span4">
                       ...
                       <div class="control-group"><label class="control-label" for="stonegroup_name">Product image</label><div class="controls"><input type="file" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="product_image" value="" name="product_image" placeholder="Product Price"></div></div>
