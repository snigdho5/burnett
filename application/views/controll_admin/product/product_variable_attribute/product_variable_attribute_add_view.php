  ...
  <div class="main-inner">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <?php } ?>
        <form class="" name="add_area" method="post" action="<?php echo base_url() . BaseAdminURl . '/'; ?>product_variable_attribute/add_submit" id="pro_submit_form" enctype="multipart/form-data">
              ...
              <div class="widget-content panel-collapse collapse in" id="general_details_area">
                ...
                <div class="span4">
                  ...
                  <div class="control-group"><label class="control-label" for="stonegroup_name">Product Regular Price</label>
                    <div class="controls"><input type="text" data-validation="required" data-validation-error-msg="Please enter title" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control product-regular-price" id="product_regular_price" value="" name="product_regular_price" placeholder="Product Regular Price"></div>
                  </div>
                ...
                <div class="span4">
                  ...
                  <div class="control-group"><label class="control-label" for="stonegroup_name">Product Sell Price</label>
                    <div class="controls"><input type="text" data-validation="required" data-validation-error-msg="Please enter title" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control  product-sell-price" id="product_price" value="" name="product_price" placeholder="Product Sell Price"></div>
                ...
                <input type="hidden" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="hidden_product_id" value="<?php echo $this->uri->segment(4); ?>" name="hidden_product_id" placeholder="Product Price">
