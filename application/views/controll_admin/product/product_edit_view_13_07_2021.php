                ...
                <div id="show_price" class="span4">
                  ...
                  <?php if (@$product_list[0]->product_type == 'simple') { ?>
                    <div class="control-group"><label class="control-label" for="stonegroup_name">Product Sell Price</label>
                      <div class="controls"><input type="text" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="product_price" value="<?php echo @$product_list[0]->product_price; ?>" name="product_price" placeholder="Product Price"></div>
                    </div>
                  <?php } ?>
                ...
                <div id="regular_price" class="span4">
                  ...
                  <?php if (@$product_list[0]->product_type == 'simple') { ?>
                    <div class="control-group"><label class="control-label" for="stonegroup_name">Product Regular Price</label>
                      <div class="controls"><input type="text" data-validation="required" data-validation-error-msg="Please enter title" class="form-control" id="product_regular_price" value="<?php echo @$product_list[0]->product_regular_price; ?>" name="product_regular_price" placeholder="Product Regular Price"></div>
                    </div>
                  <?php } ?>
                ...
                <div class="span4">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      ...
                      <textarea class="form-control" rows="3" name="product_description" id="product_description" placeholder="Component" data-validation="required" data-validation-error-msg="Please enter Component"><?php echo @$product_list[0]->product_description; ?></textarea>
