        ...
        <div class="span12 stone_details" id="stone_details">
          <div class="widget ">
            <div class="widget-header "> <i class="icon-list-ol"></i>
              <h3>Product List</h3>
              <div class="pull-right"><a href="product/bulkupload" class="btn btn-success">Bulk Upload</a> </div>
              <!-- <div class="pull-right"><a href="product/product_pickup" class="btn btn-success">Pickup Details</a> </div> -->
              <div class="pull-right"><a href="product/product_add" class="btn btn-success">ADD PRODUCT</a> </div>
            </div>
            <!-- /widget-header -->
                    ...
                    ?>
                        <tr>
                          ...
                          <td><?php
                              ...
                              $product_category_details = $this->common_my_model->common($table_name = 'product_category', $field = array(), $where = array('product_id' => @$product->product_id), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');

                              for ($i = 0; $i < count($product_category_details); $i++) {

                                $category_details = $this->common_my_model->common($table_name = 'category', $field = array(), $where = array('cat_id' => @$product_category_details[$i]->category_id), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');

                                echo $category_details[0]->name;

                                if ($i < count($product_category_details) - 1) {
                                  echo ' , ';
                                }
                              }
                          ...
                          <td><?php if ($product->product_type == 'simple') {
                                echo 'Rs. ' . $product->product_price;
                              } else {
                                echo 'No Price';
                              } ?></td>
                          <td> <?php if ($product->product_type == 'simple') {
                                  echo 'Rs. ' . $product->product_regular_price;
                                } else {
                                  echo 'No Price';
                                } ?></td>
                          ...
                          <td class="span4">
                            <!--<a href="#" class="btn btn-success"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>&nbsp; &nbsp;--><a title="delete" href="product/delete/<?php echo $product->product_id; ?>" id="del" onclick="return confirm('Are you sure ?')" class="btn btn-danger delete_button"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>&nbsp;&nbsp;<a title="Edit" href="product/product_edit/<?php echo $product->product_id; ?>" class="btn btn-success"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>

                            <a title="Gallery Image Add" href="product_gallery_image/list_view/<?php echo $product->product_id; ?>" class="btn btn-success"><span class="fa fa-picture-o" aria-hidden="true"></span></a>


                            <?php if ($product->product_type == 'variable') { ?>

                              &nbsp;&nbsp;<a title="Variable Product Add" href="product_variable_attribute/list_view/<?php echo $product->product_id; ?>" class="btn btn-danger delete_button"><span class="fa fa-rss" aria-hidden="true"></span></a>
                            <?php } ?>
                            <!--<br>
