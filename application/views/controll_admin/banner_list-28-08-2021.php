            ...
            <div class="widget-content">
              <form class="form-horizontal well" name="add_area" id="add_area" method="post" action="<?php echo base_url().BaseAdminURl.'/';?>banner/add_edit/<?php echo $this->uri->segment(4);?>" enctype="multipart/form-data">
                ...
                <fieldset>
                  ...
                  <div class="control-group">
                    <label class="control-label" for="uploaded_image">Desktop Image</label>
                    <div class="controls">
                  ...
                  <div class="control-group">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="banner_first_heading" class="form-control" value="" placeholder="Enter banner first heading" data-validation="required">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="banner_second_heading" class="form-control" value="" placeholder="Enter banner second heading" data-validation="required">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="banner_third_heading" class="form-control" value="" placeholder="Enter banner third heading" data-validation="required">
						</div>
					</div>
