    ...
    <ul class="navbar-nav navbar-center navbar-light">
     ...
     <li class="nav-item">
	  ...
	  foreach($category_list as $row){
		  ...
		  ?>
      <li class="nav-item dropdown megamenu-li dmenu">
                <a class="nav-link <?php if(count(@$sub_category_list)>0){echo ' dropdown-toggle';}?>" href="<?php echo base_url().'product-list/'.$row->unique_name; ?>" id="dropdown<?php echo $row->cat_id;?>" <?php if(count(@$sub_category_list)>0){?> data-toggle="dropdown" aria-haspopup="true"<?php } ?> aria-expanded="false"><?php echo $row->name;?></a>
                ...
                <div class="dropdown-menu megamenu sm-menu border-top" aria-labelledby="dropdown<?php echo $row->cat_id;?>">
                    <div class="row">
                        ...
                        $my_parent_category_details=  $this->common_my_model->common($table_name ='category', $field = array(), $where = array('cat_id'=>@$subcatrow->parent_id), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = ''); ?>                          
                            <a class="dropdown-item" href="<?php echo base_url().'product-list/'.@$my_parent_category_details[0]->unique_name.'/'.$subcatrow->unique_name; ?>"><?php echo $subcatrow->name;?></a>
                         <?php } ?>
