        ...
        <div class="container">    
            ...
            <div class="product-grid4">
                <div class="product-image4">
                   <?php error_reporting(0); if($row->category_image !=''){ ?> <a href="<?php echo base_url().'product-list/'.@$my_parent_category_details[0]->unique_name.'/'.$row->unique_name; ?>"><img class="pic-1" src="<?php echo base_url();?>uploads/<?php echo $row->category_image;?>" style="height:100px;width: 200px" alt=""/> </a> <?php } ?>
           ...
           // $interval=$time1-$time2;
            ...
            if($interval >0){
                ...
                <div class="product-content">
                    ...
                    <a class="add-to-cart" href="<?php echo base_url();?>product-details/<?php echo $row->unique_key;?>">ADD TO CART</a>
                </div>
            </div>
