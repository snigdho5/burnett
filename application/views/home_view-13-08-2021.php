            ...
            <div class="product-grid4">
                ...
                <div class="product-content">
                    ...
                    <a class="add-to-cart" href="">ADD TO CART</a>
                        ...
                        <?php foreach ($product_list as $row) { //echo "<pre>";print_r($row->product_title); ?>

                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 pl-1 pr-1">
                                <div class="product-grid4">
                                    <div class="product-image4">

                                        <?php if ($row->product_image != '') { ?> <a href="<?php echo base_url(); ?>product-details/<?php echo $row->unique_key; ?>"><img class="pic-1" src="<?php echo base_url(); ?>uploads/product/small/<?php echo $row->product_image; ?>" alt="<?php echo isset($row->product_title)?$row->product_title:'';?>" /> </a> <?php } ?>
