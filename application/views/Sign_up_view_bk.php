...
function dr_data_Submit_fm()
{
        ...
        if (dr_have_registration_no=="") 
        {
            $('#dr_have_registration_no').removeClass('black_border').addClass('red_border');
        } 
        else 
        {
        ...
        else 
        {
            ...
            $('#dr_have_registration_no').removeClass('red_border').addClass('black_border');               
        }
...
function change_dr_registration(){
  ...
  var change_reg_val=  $("#dr_have_registration_no").val();
...
function di_data_Submit_fm()
{
        ...
        if (di_prev_any_delarship=="") 
        {
            $('#di_prev_any_delarship').removeClass('black_border').addClass('red_border');
        } 
        else 
        {
        ...
        else 
        {
            ...
            $('#di_prev_any_delarship').removeClass('red_border').addClass('black_border');               
        }
...
function st_data_Submit_fm()
{
        ...
        if (st_prev_any_delarship=="") 
        {
            $('#st_prev_any_delarship').removeClass('black_border').addClass('red_border');
        } 
        else 
        {
        ...
        else 
        {
            ...
            $('#st_prev_any_delarship').removeClass('red_border').addClass('black_border');               
        }
