...
<div class="container pt-4 pb-4">
 ...
 <div class="row">
    <div class="col-md-12">
          ...
          <!-- Title -->
          <h1 class="mt-4"><?php echo @$blog_details[0]->news_title;?></h1>
          ...
          <!-- Preview Image -->
          <img class="card-img-top" src="<?php echo base_url();?>uploads/news/large/<?php echo $blog_details[0]->image;?>" alt="Card image cap">
...
<div class="col-md-8">
    <small><?php
          ...
          <div class="card my-4">
            ...
            <div class="card-body">
              <form id="cu_registration_form" action="<?php echo base_url();?>news/news_review_submit" method="post" enctype="multipart/form-data" >
