...
{	
  ...
  //  $data['seo_content_details']=  $this->common_my_model->common($table_name ='seo_module', $field = array(), $where = array('seo_module_id'=>'9'), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');
		...
		$data['product_review_count']=$this->common_my_model->common($table_name = 'product_review', $field = array(), $where = array('product_id'=>$product_id), $where_or = array(), $like = array(), $like_or = array(), $order = array(), $start = '', $end = '');
