...
Array ( [category_image] => Array ( [name] => facebook_icon.png [type] => image/png [tmp_name] => D:\wamp64\tmp\php4E7C.tmp [error] => 0 [size] => 1153 ) ) 
			...
			if($this->form_validation->run() == TRUE){
				...
				$data['banner_first_heading'] 	= $this->input->post('banner_first_heading');
				$data['banner_second_heading'] 	= $this->input->post('banner_second_heading');
				$data['banner_third_heading'] 	= $this->input->post('banner_third_heading');
				$data['banner_alt_tag'] 		= $this->input->post('banner_alt_tag');
