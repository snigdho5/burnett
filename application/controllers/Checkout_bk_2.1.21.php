...
{	
      ...
      ?>
       ...
       <div class="row">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="bil_pincode" name="bil_pincode" placeholder="Enter your Contact No" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="6" value="<?php echo @$user_billing_address_details[0]->pincode; ?>" readonly >
            </div>
              ...
              <div class="col-md-5 mb-3">
                ...
                <!-- <select class="custom-select d-block w-100" id="bil_country" name="bil_country" >
                   <option value="">Select Country</option>
                    <option value="India" <?php if(@$user_billing_address_details[0]->country=='India'){echo 'selected';}?>   >India</option>
                </select> -->
              ...
              <div class="col-md-4 mb-3">
                <label for="state">State</label>
                 ...
                 <!-- <select class="custom-select d-block w-100" id="bil_state" name="bil_state"  onchange="calculate_gst(this.value);" >
                   <option value="">Select State</option>
                                     <?php foreach($state_list as $row){?>
                                      <option value="<?php echo $row->name; ?>" <?php  if(@$user_billing_address_details[0]->state==$row->name){echo 'selected';}?>   ><?php echo $row->name; ?></option>
                                    <?php } ?>
                </select>  -->
    ...
    <?php
       	...
       	<div class="row">
            ...
            <div class="mb-3">
              <label for="address2">Pincode </label>
              <input type="text" class="form-control" id="bil_pincode" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="6" name="bil_pincode" placeholder="Enter your Contact No" value="" >
            </div>
