...
{	
	...
	<div class="col-md-9">
	 ...
	 <form class="form-horizontal" id="add_manage_address_registration_form" action="<?php echo base_url();?>manage_address/add_submit" method="post" enctype="multipart/form-data">
                                   ...
                                   <input type="text" class="form-control" name="name" id="name" value="<?php echo @$user_details[0]->firstname.' '.@$user_details[0]->lastname;?>"  placeholder="Enter your First Name" />
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">                                                
                                   <input type="text" class="form-control" name="phone" id="phone" value="<?php echo @$user_details[0]->phone;?>" placeholder="Enter your Contact No" />
                                            </div>
                                        </div>
                                    </div> 
                                   ...
                                   <input type="text" class="form-control" name="flat_house_floor_building" id="flat_house_floor_building" value="" placeholder="Enter your Contact No" />
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">                                                
                                   <input type="text" class="form-control" name="pincode" id="pincode" value="" placeholder="Enter your Pincode" />
                                            </div>
                                        </div>
                                    </div> 
	...
	<div class="col-md-9">
	 ...
	 <form class="form-horizontal" id="edit_manage_address_registration_form" action="<?php echo base_url();?>manage_address/edit_submit" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">                                                
                                   <input type="text" class="form-control" name="name" id="name" value="<?php echo @$manage_address_details[0]->name; ?>"  placeholder="Enter your First Name" />
                                   <input type="hidden" class="form-control" name="id" id="id" value="<?php echo @$manage_address_details[0]->id; ?>"  placeholder="Enter your First Name" />
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">                                                
                                   <input type="text" class="form-control" name="phone" id="phone" value="<?php echo @$manage_address_details[0]->phone; ?>" placeholder="Enter your Contact No" />
                                            </div>
                                        </div>
                                    </div> 
                                   ...
                                   <input type="text" class="form-control" name="flat_house_floor_building" id="flat_house_floor_building" value="<?php echo @$manage_address_details[0]->flat_house_floor_building; ?>" placeholder="Enter your Contact No" />
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="cols-sm-10">
                                            <div class="input-group">                                                
                                   <input type="text" class="form-control" name="pincode" id="pincode" value="<?php echo @$manage_address_details[0]->pincode; ?>" placeholder="Enter your Pincode" />
                                            </div>
                                        </div>
                                    </div> 
                                   ...
                                   <select class="form-control" name="country" id="country" >
                                     ...
                                     <?php foreach($country_list as $row){?>
                                      ...
                                      if(@$manage_address_details[0]->country==$row->name){echo 'selected';}?>   ><?php echo $row->name; ?></option>
                                    <?php } ?>
                                   </select>
                                            </div>
                                        </div>
...
function delete_address($id)
	{
        ...
        $this->session->set_flashdata('exist','Deleted your address.');
	    redirect(base_url().'my-account', 'refresh');
